function createDictionaryPanel(apptitle) {
	// 分页大小。
	var pagesize = 25;
	var status = false;
	var action;
	...
	var panel = new Ext.Panel({
		...
		tbar : [
				...
				},
				{
					...
					disabled : true,
					handler : function() {
						Ext.MessageBox.confirm('删除确认', '你确定要删除所选中的数据字典表吗？',
								function(id) {
									if (id == 'yes') {
										var ids = '';
										// 删除数据字典表。
