function createArticlePanel(apptitle){
	...
	var articleFormConfig = {
		...
		//name是form提交是用到的名字,id:为dom所用,dataIndex:为映射数据所用。
				{name:'article.id',id:'id',xtype:'hidden'},
				{name:'article.title',id:'title',fieldLabel:'文章标题'},
				{name:'article.author',id:'author',fieldLabel:'作者'},
				{name:'article.content',id:'content',fieldLabel:'文章正文'},
				{name:'article.img',id:'img',fieldLabel:'图片'},
				{name:'article.createTime',id:'createTime',format:'Y-m-d H:i:s',xtype:'datefield',fieldLabel:'创建时间'},
				{name:'article.updateTime',id:'updateTime',format:'Y-m-d H:i:s',xtype:'datefield',fieldLabel:'修改时间'},
				{name:'article.status',value:1,id:'status',xtype:'checkbox',fieldLabel:'状态'},
				{name:'article.clickTimes',id:'clickTimes',fieldLabel:'点击次数'},
				{name:'article.shareTimes',id:'shareTimes',fieldLabel:'分享次数'},
				{name:'article.favTimes',id:'favTimes',fieldLabel:'收藏次数'},
				{name:'article.bigColumn',id:'bigColumn',fieldLabel:'大栏目'},
				{name:'article.smallColumn',id:'smallColumn',fieldLabel:'小栏目'},
				{name:'article.keyword',id:'keyword',fieldLabel:'关键字'}
		],
		buttons:[
			{
				text: '保&nbsp;&nbsp;&nbsp;存',
	...
	var grid= new Ext.grid.GridPanel({
		...
		cm:new Ext.grid.ColumnModel({
			columns:[
				sm,
				{id:'title',header:'文章标题',width:80,sortable:true,dataIndex:'title'},
				{id:'author',header:'作者',width:80,sortable:true,dataIndex:'author'},
				{id:'content',header:'文章正文',width:80,sortable:true,dataIndex:'content'},
				{id:'img',header:'图片',width:80,sortable:true,dataIndex:'img'},
				...
				{id:'clickTimes',header:'点击次数',width:80,sortable:true,dataIndex:'clickTimes'},
				{id:'shareTimes',header:'分享次数',width:80,sortable:true,dataIndex:'shareTimes'},
				{id:'favTimes',header:'收藏次数',width:80,sortable:true,dataIndex:'favTimes'},
				{id:'bigColumn',header:'大栏目',width:80,sortable:true,dataIndex:'bigColumn'},
				{id:'smallColumn',header:'小栏目',width:80,sortable:true,dataIndex:'smallColumn'},
				{id:'keyword',header:'关键字',width:80,sortable:true,dataIndex:'keyword'}
			],
			defaults: {
				sortable: true,
				menuDisabled:false,
	...
	var panel = new Ext.Panel({
		...
		tbar:[
			...
			{
				text:'编辑',ref: '../editButton',tooltip:'编辑选中的文章表',iconCls:'edit-icon',disabled:true,
				handler:function(){
					createArticleForm('编辑文章表',sm.getSelected().data.id);
				}
			},			
			{
				text:'删除',ref: '../removeButton',tooltip:'删除选中的文章表',iconCls:'delete-icon',disabled:true,
				handler:function(){
