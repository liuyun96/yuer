...
public class Constant {
	...
	// 菜单值
	public static final String uri_index = "vitv";// 首页
	public static final String uri_sjzg = "sjzg";// 会员专区
	...
	public static final String uri_dd = "dd";// 餐饮热券
	public static final String uri_kind = "kind";// 分类
	public static final String uri_game = "index_h";// 活动页面
	public static final String uri_detail = "detail";// 详情页
	public static final String uri_sure = "sure";// 包月确认
	...
	public static final String activity_name_current = "否";
