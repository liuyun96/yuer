...
public class BuyerService {
	...
	public Buyer getBuyer(Serializable id) {
		return (Buyer) ht.getSession().get(Buyer.class, id);
	}

	@SuppressWarnings("unchecked")
	public Collection<Buyer> findBuyerByExample(Buyer searchForm,
	...
	private Criteria createCriteria(Buyer searchForm) {
		Criteria criteria = ht.getSession().createCriteria(Buyer.class);
		return criteria;
	}
	...
	public void delete(String ids) {
		...
		ht.getSession().createQuery(
				"delete from Buyer where id in ("+ids+")").executeUpdate();
	}
