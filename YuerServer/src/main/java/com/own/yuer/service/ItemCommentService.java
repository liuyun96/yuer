...
public class ItemCommentService {
	...
	public ItemComment getItemComment(Serializable id) {
		return (ItemComment) ht.getSession().get(ItemComment.class, id);
	}

	@SuppressWarnings("unchecked")
	public Collection<ItemComment> findItemCommentByExample(ItemComment searchForm,
	...
	private Criteria createCriteria(ItemComment searchForm) {
		Criteria criteria = ht.getSession().createCriteria(ItemComment.class);
		return criteria;
	}
	...
	public void delete(String ids) {
		...
		ht.getSession().createQuery(
				"delete from ItemComment where id in ("+ids+")").executeUpdate();
	}
